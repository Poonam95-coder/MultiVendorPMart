    ...
    <div className="space-y-6">
            ...
            {categoriesWithAll.map((cat:any)=>(
                <button key={cat.slug}
                 ...
                 className={`block w-full text-left px-3 py-2 text-sm
                  rounded-md transition-all ${category===cat.slug ? "bg-app-green text-white"
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
            ...
            className="w-full px-3 py-2 textsm bg-white rounded-lg
             border not-focus:border-app-border"/>
      ...
      {hasFilters && (
        ...
        className="w-full py-2 text-sm text-app-error 
