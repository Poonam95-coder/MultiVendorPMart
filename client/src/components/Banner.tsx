...
//here we create top banner which is displayed on the top of screen
...
const Banner = () => {
  ...
  return (
    <div>
    {bannerVisible &&(
        <div className="bg-linear-to-r from-app-green via-emrald-800 to-app-green text-white text-xs sm:text-sm relative overflow-hidden">
            <div className="max-w-7xl mx-auto ox-4 sm:px-6 lg:px-8 py-2
            flex-center gap-6">
                <div className="flex-center gap-2">
                    <TruckIcon className="sixe-4 shrink-0"/>
