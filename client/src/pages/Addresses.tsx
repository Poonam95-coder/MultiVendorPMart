...
useEffect(()=>{ apiGet('/addresses').then(d=>setAddresses(d.addresses||[])).finally(()=>setLoading(false)); },[])
  return (
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          className="px-4 py-2 bg-app-green text-white text-sm font-semibold rounded-xl hover:bg-app-green-light
    ...
    resetForm={resetForm} handleSubmit={handleSubmit} 
         ...
         addresses.length===0?  (
          <div className="text-center py-16">
            ...
            <h2 className="text-lg font-semibold text-app-green mb-2">
              No addresses saved</h2>
            <p className="text-sm text-app-text-light">
              Add an address for faster checkout</p>
            </div>
         )
         :(
