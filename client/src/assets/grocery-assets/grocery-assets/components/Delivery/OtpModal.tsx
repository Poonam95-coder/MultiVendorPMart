            ...
            <div className="fixed inset-0 z-50 flex-center p-4">
                <div className="bg-white rounded-2xl p-6 w-full max-w-sm animate-fade-in">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={handleComplete} disabled={!/^\d{6}$/.test(otp) || submitting} className="flex-1 py-2.5 text-sm font-medium text-white bg-green-600 rounded-xl hover:bg-green-700 transition-colors disabled:opacity-50">
