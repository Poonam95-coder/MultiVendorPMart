...
export const appPromoBannerData = {
    title: "Shop Smarter with TrustCart",
    description: "Experience farm-fresh groceries, verified seller trust ratings, and lightning-fast delivery straight to your doorstep.",
};

export const footerData = {
    brand: {
        name: "TrustCart",
        description: "Bringing verified fresh, organic groceries and trusted local sellers straight to your doorstep. Quality you can trust, delivered with care.",
        socials: [
            { icon: SiFacebook, link: "https://facebook.com" },
    ...
    sections: [
        {
            ...
            links: [
                ...
                { label: "Delivery Portal", to: "/delivery" },
            ],
        },
        {
            ...
            links: [
                ...
                { label: "Role Selection", to: "/welcome" },
            ],
        },
    ],

    contact: [
        { icon: MapPinIcon, text: "100 TrustCart Way, Suite 400" },
        { icon: PhoneIcon, text: "+1 (800) 555-TRUST" },
        { icon: MailIcon, text: "support@trustcart.com" },
    ],

    bottom: {
        copyright: "© 2026 TrustCart Inc. All rights reserved.",
        links: [
            { label: "All Products", to: "/products" },
...
export const dummySellerData = {
  profile: {
    ...
    avatar:
      "https://ui-avatars.com/api/?name=Fresh+Farm&background=4CAF50&color=fff",
    joinedAt: "2026-01-15",
  },
...
dashboard: {
  ...
  activeProducts: dummyProducts.filter((p) => p.stock > 0).length,

  outOfStock: dummyProducts.filter((p) => p.stock === 0).length,

  totalOrders: dummyDashboardOrdersData.length,

  pendingOrders: dummyDashboardOrdersData.filter(
    (o) => o.status !== "Delivered"
  ).length,

  completedOrders: dummyDashboardOrdersData.filter(
    (o) => o.status === "Delivered"
  ).length,

  totalRevenue: dummyDashboardOrdersData.reduce(
    (sum, order) => sum + order.total,
    0
  ),

  recentOrders: dummyDashboardOrdersData,

  topProducts: [...dummyProducts]
