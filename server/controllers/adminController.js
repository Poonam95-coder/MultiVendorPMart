...
exports.dashboard = async (req, res, next) => {
    try {
        // Get all required counts and recent orders
        const [
            totalOrders,
            totalUsers,
            totalProducts,
...
// Get sellers according to selected tab
exports.getSellers = async (req, res, next) => {
    try {
        ...
        // Add product, order and trust information for each seller
...
// Get complete details of one seller
exports.getSellerById = async (req, res, next) => {
    try {
        ...
        // Get seller's products, orders and trust details
...
exports.approveSeller = async (req, res, next) => {
    try {
        ...
        // Update trust score after seller approval
...
exports.rejectSeller = async (req, res, next) => {
    try {
        ...
        // Update trust score after rejection
        const trust = await recalculateSellerTrust(seller._id);
...
exports.activateSeller = async (req, res, next) => {
    try {
        ...
        // Recalculate trust after activation
        const trust = await recalculateSellerTrust(seller._id);
...
exports.verifySeller = async (req, res, next) => {
    try {
        ...
        // Use the value from request, otherwise toggle current value
...
// Change seller active/suspended status
exports.toggleSellerStatus = async (req, res, next) => {
    try {
        ...
        // Use requested status or toggle the current status
        if (req.body.isActive !== undefined) {
            seller.isActive = Boolean(req.body.isActive);
        } else {
        ...
        // Update trust score after status change
        const trust = await recalculateSellerTrust(seller._id);
